...
class CasesClient:
    ...
    def create_citizen_case(self, citizen: dict, base_case_name: str, case_name: str = None) -> Optional[dict]:
        ...
        try:
            ...
            base_cases_response = self.client.get(citizen["_links"]["availablePathwayAssociation"]["href"])
            ...
            pathways_response = self.client.get(matching_base_case["_links"]["self"]["href"])
            ...
            active_programs_response = self.client.get(base_case_details["_links"]["activePrograms"]["href"])
            active_programs = active_programs_response.json() if active_programs_response.status_code == 200 else []
            
            # Get available nested program pathways
            available_pathways_response = self.client.get(base_case_details["_links"]["availableNestedProgramPathways"]["href"])
            ...
            for program in active_programs:
                if program.get("id") == matching_pathway.get("id"):
            ...
            enroll_response = self.client.put(
                matching_pathway["_links"]["enroll"]["href"],
                json={}
            )
    ...
    def close_case(self, case_reference: dict) -> bool:
        ...
        try:
            ...
            case_details_response = self.client.get(case_reference["_links"]["self"]["href"])
            ...
            unclosable_response = self.client.get(case_details["_links"]["unclosableReferences"]["href"])
            ...
            close_response = self.client.put(
                case_details["_links"]["close"]["href"],
                json={}
            )
